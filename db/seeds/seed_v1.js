exports.seed = function(knex, Promise) {
  ...
  return Promise.all([
    ...
    .then(function() {
      return Promise.all([
          knex('options').insert({ option_id: 1, admin_link: "aA1bB3ZZ", option_text: "pikachu"}),
          knex('options').insert({ option_id: 2, admin_link: "aA1bB3ZZ", option_text: "diglet"}),
          ...
          knex('options').insert({ option_id: 5, admin_link: "aa1bb3zz", option_text: "cherry-berry"})
          ]);
    })
    .then(function() {
      return Promise.all([
